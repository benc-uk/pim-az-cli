...
setup(
    name="pim",
    version=VERSION,
    description="Microsoft Azure Command-Line Tools PIM Extension",
    # TODO: Update author and email, if applicable
    author="Ben Coleman",
    author_email="benc.uk@gmail.com",
    # TODO: change to your extension source code repo if the code will not be put in azure-cli-extensions repo
    url="https://github.com/benc-uk/pim-az-cli",
    long_description=README + "\n\n" + HISTORY,
    license="MIT",
    classifiers=CLASSIFIERS,
    packages=find_packages(),
    install_requires=DEPENDENCIES,
    package_data={"azext_pim": ["azext_metadata.json"]},
)
